...
*   **Does my web app need to solve a problem? What kind of problem?**
    ...
    Yes, the deliverable for TechUp is to build your own web app (frontend)  that solves a problem of your choice. The web app you build should meet the requirements stated in [this webpage](../about-techup/expected-deliverables/).&#x20;
